...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: GetBuilder<ProfileScreenController>(builder: (controllers) {
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon:
                                  const Icon(Icons.label, color: Colors.white70),
                                ),
                                validator: (value) {
                              ...
                              Obx(() {
                                return controller.loading.value
                                  ...
                                  child: CircularProgressIndicator(
                                    ...
                                    : ElevatedButton.icon(
                                  onPressed: controller.images.where((image) => image != null).length < 3 ? () => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Please upload 3 images'))) : controller.submitForm,
